    ...
    <section class="blogs-detail py-5 mt-5">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="blog-item ">
                            <img src="{{asset('admin/images/blogs/'. $blog->image)}}" class="w-100" alt="">
                            <div class="blog-item-text p-2">
                                <h4 class="p-2 pb-4 fw-bold fs-5 border-bottom text-center">{{$blog->title}}</h4>
